            ...
            {comments.map((comment, i) => (
                < div key={i}>
                    ...
                    <IonItem lines="none" color={'lightt'} style={{ marginTop: 0, marginLeft: -3, marginBottom: 0, paddingTop: 5, paddingBottom: 5 }} >
                        ...
                        <div style={{position: 'absolute', top: 3, borderRadius: 100, padding: 1, border: '1px solid var(--ion-color-medium)'}}><MemberPfp color='dark' size="smol" style={{ top: 0}}address={comment.author} />
                        </div>
