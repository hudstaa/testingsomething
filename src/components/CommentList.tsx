            ...
            {comments.map((comment, i) => (
                < div key={i}>
                    ...
                    <IonItem lines="none" color={'lightt'} style={{ marginTop: 0, marginLeft: -3, marginBottom: 0, paddingTop: 5, paddingBottom: 5 }} >
                        ...
                        <IonText className='regular' color='dark' style={{ paddingLeft:45, whitespace: 'pre-wrap', marginTop: 25, marginLeft: 0, marginBottom: 5, fontSize: "1rem", letterSpacing: '-.3px'}} >
                            {comment.content}
                        </IonText>
                        <IonButtons slot='end'>
