        ...
        <IonList style={{ marginRight: offset ? -35 : undefined }}>
            ...
            {comments.map((comment, i) => (
                < div key={i}>
                    ...
                    <IonItem lines="none" color={'lightt'} style={{  borderTop: '1px solid var(--ion-color-medium-shade)', marginTop: 0, marginLeft: -4, marginBottom: 0, paddingTop: 8, paddingBottom: 8 }} >
                        ...
                        <IonText color={'dark'} className='light' style={{ paddingBottom: 0, marginLeft: 3, bottom: 0, fontSize: "1rem", opacity: '50%' }}>
