            ...
            {comments.map((comment, i) => (
                < div key={i}>
                    ...
                    <IonItem lines="none" color={'lightt'} style={{  borderTop: '1px solid var(--ion-color-medium-shade)', marginTop: 0, marginLeft: 0, marginBottom: 0, paddingTop: 8, paddingBottom: 8 }} >
                        ...
                        <IonText className='regular' color='dark' style={{ paddingLeft:0, whitespace: 'pre-wrap', marginTop: 42, marginLeft: 1, marginBottom: 0, fontSize: "1.05rem", letterSpacing: '-0.0135em'}} >
                            <Linkify>
                                {comment.content}
                            </Linkify>
                        </IonText>
