...
export const MemberCardHeader: React.FC<{ clickable?: boolean, address: string, color?: string, content?: ReactElement[] | ReactElement }> = ({ address, color = undefined, content, clickable = true }) => {
    ...
    return <IonRow >
        <IonGrid fixed style={{ paddingLeft: 0 }}>
            <IonRow>
                <div style={{ display: 'flex', flexDirection: 'column', cursor: 'pointer', fontSize: '.95rem', margin: 0, marginTop: 1, paddingBottom: 0 }}>
                    <div>
                        <IonText onMouseDown={() => {
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', cursor: 'pointer', margin: 0, marginTop: -2, paddingBottom: 0 }}>
