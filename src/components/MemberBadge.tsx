    ...
    return <IonRow >
        <IonGrid fixed style={{ paddingLeft: 0 }}>
            <IonRow>
                ...
                }} color='dark' className='medium' style={{ cursor: 'pointer!important', opacity: '75%', fontSize: '12px', margin: 0, padding: 0 }}>
                    @{member?.twitterUsername}
                </IonText>
                {/* Bullet Point */}
                <IonText color='dark' style={{ paddingLeft: 4, paddingRight: 4, fontSize: 10, paddingTop: 2 }}>
                    •
                </IonText>
                <IonText color='dark' className='medium' style={{ opacity: '75%', fontSize: 12 }}>
                    {content ? content : <></>}
                </IonText>
            </IonRow>
        </IonGrid>
