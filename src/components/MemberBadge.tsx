    ...
    return <IonRow >
        <IonGrid fixed style={{ paddingLeft: 0 }}>
            <IonRow>
                ...
                }} color='dark' className='semi' style={{ cursor: 'pointer!important', fontSize: '16px', margin: 0, paddingBottom: 1, letterSpacing: '-0.0235em' }}>
                    {member?.twitterName}
                </IonText>
                {/* Bullet Point */}
                <IonText color='dark' className='reg' style={{ paddingLeft: 4, paddingRight: 4, fontSize: 10, paddingTop: 5, opacity: '75%' }}>
                    •
                </IonText>
                <IonText color='dark' className='reg' style={{ opacity: '75%', paddingTop: '3.2px', fontSize: 12 }}>
                    {content ? content : <></>}
                </IonText>
            </IonRow>
        </IonGrid>
