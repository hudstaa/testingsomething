    ...
    return <IonRow >
        <IonGrid fixed style={{ paddingLeft: 0 }}>
            <IonRow>
                ...
                }} color='dark' className='heavy' style={{ cursor: 'pointer!important', fontSize: '16px', margin: 0, padding: 0, letterSpacing: '-0.0235em' }}>
                    {member?.twitterName}
                </IonText>
                {/* Bullet Point */}
                <IonText color='dark' style={{ paddingLeft: 4, paddingRight: 4, fontSize: 12, paddingTop: 4, opacity: '75%' }}>
                    •
                </IonText>
                <IonText color='dark' className='semi' style={{ opacity: '75%', paddingTop: 3, fontSize: 11 }}>
                    {content ? content : <></>}
                </IonText>
            </IonRow>
        </IonGrid>
