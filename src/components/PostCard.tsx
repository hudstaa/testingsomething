    ...
    return  <div style={cardStyle} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}><IonCard  onMouseDown={(e) => {
        ...
        {<IonRow className="GPT" style={gptRowStyle}>
            <IonButton style={{ marginLeft: -1, marginBottom: 0, marginTop:0}} routerDirection="root" color='dark' fill="clear" onMouseDown={() => {
                 ...
                 <IonIcon color={'medium'} icon={'/icons/msgo.svg'} style={{ height: 16, width: 16 }} /> 
                <IonText color={'medium'} className="regular" style={{ fontSize: "1rem", marginTop: 0, marginLeft: 4, color: 'var(--ion-color-soft)' }}>
            ...
            <IonButton style={{ marginLeft: -14, marginBottom: 0, marginTop: 0}} color='dark' fill='clear' size='small' onMouseDown={() => {
                ...
                <IonIcon icon={'/icons/send.svg'} style={{ height: 16, width: 16 }}/>
            ...
            <IonButton style={{ marginLeft: 0, marginBottom: 0, marginTop: 0}} color='dark' fill='clear' size='small' onMouseDown={() => {
                ...
                <IonIcon icon={'/icons/bookmark.svg'} style={{ height: 16, width: 16 }}/>
                {/* <IonIcon icon={'/icons/se.svg'} style={{ height: 18, width: 18, marginTop: 2, marginLeft: '-7px', color: 'var(--ion-color-soft)' }} /> */}
            </IonButton>
            <IonButton style={{ marginLeft: 0, marginBottom: 0, marginTop: 0}} color='dark' fill='clear' size='small' onMouseDown={() => {
                setLocalNotif("Copied to share link to clipboard")
                ...
                <IonIcon icon={'/icons/share.svg'} style={{ height: 17, width: 17 }}/>
                {/* <IonIcon icon={'/icons/se.svg'} style={{ height: 18, width: 18, marginTop: 2, marginLeft: '-7px', color: 'var(--ion-color-soft)' }} /> */}
            </IonButton>
            <div style={{ marginLeft: '10%', marginRight: -8, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <IonButton fill='clear' onPointerDown={() => handleVote(id, uid, false)} color={typeof voted !== 'undefined' && voted !== null && voted === -1 ? 'tribe' : 'medium'} >
                    <IonIcon icon={typeof voted !== 'undefined' && voted !== null && voted === -1 ? '/icons/ardoo.svg' : '/icons/ardo.svg'} style={{ marginRight: -8, height: 18, width: 18 }} />
                </IonButton>
                <IonLabel style={{
                    fontSize: '1rem', width: 36, alignItems: "middle", textAlign: 'center', fontVariantNumeric: 'tabular-nums'
                }} >
                    <IonText color={typeof voted !== 'undefined' && voted !== null && voted === 1 ? 'tribe' : 'tribe'} className='fab ion-text-center'>{score} </IonText>
                </IonLabel>
                <IonButton  fill='clear' onPointerDown={() => handleVote(id, uid, true)} color={typeof voted !== 'undefined' && voted !== null && voted === 1 ? 'tribe' : 'medium'}>
                    <IonIcon icon={typeof voted !== 'undefined' && voted !== null && voted === -1 ? '/icons/arup.svg' : '/icons/arupo.svg'} style={{marginLeft: -8, marginRight: 0, height: 18, width: 18 }} />
                </IonButton>
            </div>
        </IonRow>}
