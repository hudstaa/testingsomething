        ...
        <IonToolbar style={{ padding: 2 }}>
          ...
          <IonButtons slot='start'>
            ...
            <IonTextarea
              ...
              ref={textRef}
              autoGrow
              style={{ '--placeholder-font-family': 'rubik', flex: 1, paddingTop: 0, marginBottom: -15}} /* flex: 1 allows the textarea to grow and fill available space */
              value={content}
