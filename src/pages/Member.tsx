    ...
    return (
        <IonPage ref={pageRef}>
            ...
            < TribeContent fullscreen color={bgColor} >
                <IonImg src={member?.twitterPfp} style={{ width: '100%', height: '5vh', filter: 'blur(8px)', transform: 'scale(10)', overflow: 'hidden' }} />
                <div style={{ paddingLeft: '12px', position: 'relative', zIndex: 555, width: '100px' }}>
                    <img style={{ width: 80, height: 80, borderRadius: '24px', marginTop: 0, border: '3px solid var(--ion-color-tabblur)' }} src={member?.twitterPfp || personOutline} />
                </div>
                <IonCard color={'black'} style={{ backgroundColor: 'var(--ion-color-tabblur)', marginLeft: 0, marginRight: 0, marginTop: '-50px', marginBottom: 0, padding: 0, borderRadius: 0, overflow: 'visible', zIndex: 444 }}>
                    ...
                    <IonCardHeader className='ion-image-left' style={{ padding: 15, borderBottom: 0, zIndex: 777 }}>
                        ...
                        <div style={{ marginTop: '-8px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center', width: '100%', zIndex: 777 }}>
                            ...
                            {member && <IonButton disabled={address === '0x0000000000000000000000000000000000000000'} size='small' style={{ border: "4px solid #FF6000", borderRadius: 20, margin: '0', marginLeft: 5, zIndex: 777 , marginRight: -10}} color='tribe' onMouseDown={() => { highlight(member!.address) }}>
