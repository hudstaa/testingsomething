                            ...
                            <IonGrid style={{padding: 0}}>
                                <IonRow>
                                    <IonCol style={{padding: 0}} sizeLg='6' sizeXs='12' sizeMd='6' offsetLg='3' offsetMd='3' offsetSm='3'>
                                        {(boosters as any)[0]?.map((holder: any, i: number) => <IonItem  style={{ '--padding-start': '4px', paddingTop: 0, paddingBottom: 0, '--inner-padding-end': '0','--border-color': 'var(--ion-color-vote)' }} key={i} lines='full'>
