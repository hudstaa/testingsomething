...
const Posts: React.FC = () => {
    ...
    return (
        ...
        <IonPage id="main-content" ref={pageRef}>
            ...
            <div style={{height: '5.8vh', marginBottom: -2, paddingBottom: 2, backgroundColor: "black", display: 'flex', flexDirection: 'row', borderTopLeftRadius: '28px', borderTopRightRadius: '28px', paddingLeft: 8, paddingRight: 8, paddingTop: 6}}> 
                <IonSegment
                    value={filterType}
                    slot='start'
                    className="heavy my-custom-segment-class2"
                    style={{ fontSize: 24,display: 'flex', paddingLeft: 3, border: '1px solid #FFFFFF10',paddingRight: 3, justifyContent: 'space-between', alignItems: 'center', borderRadius: 24, paddingBottom: 1}} >
