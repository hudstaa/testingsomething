        ...
        <IonPage ref={pageRef}>
                        ...
                        <IonButtons slot='start' color='transparent' style={{ width: '100%' }}>
                            ...
                            >
                                <IonSegmentButton value={'top'} color={postType === 'top' ? 'medium' : 'paper'}>
                                    <IonLabel className='heavy' style={{fontSize: 16, paddingBottom: 6}}>Top</IonLabel>
                                </IonSegmentButton>
                                <IonSegmentButton value={'recent'} color={postType === 'recent' ? 'medium' : 'paper'}>
                                    <IonLabel className='heavy' style={{fontSize: 16, paddingBottom: 6}}>New</IonLabel>
                                </IonSegmentButton>
                            </IonSegment>
                        </IonButtons>
                    </IonToolbar> 
            ...
            < IonContent color={bgColor} fullscreen onIonScroll={(e: any) => {
                ...
                <IonFab slot="fixed" vertical="bottom" horizontal="end">
                    ...
                    }} className="bold" style={{ cursor: 'pointer', borderRadius: '1000px', color: 'white', background: '#FF6000', padding: '0px', paddingBottom: 10, height: '56px', width: '56px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '44px',  }}>
                        +
                    </div>}
                </IonFab>
            </IonContent >
