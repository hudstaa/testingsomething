        ...
        <TribePage page='posts'>
            ...
            < TribeContent fullscreen page='posts'>
                ...
                <IonFab slot="fixed" vertical="bottom" horizontal="end">
                    ...
                    }} style={{ cursor: 'pointer', borderRadius: '1000px', color: 'white', background: '#FF6000', padding: '10px', height: '50px', width: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: 'bold', }}>
                        +
                    </div>}
                </IonFab>
            </TribeContent >
