...
const Posts: React.FC = () => {
    ...
    return (
        ...
        <IonPage id="main-content" ref={pageRef}>
            ...
            <div style={{height: '5.9vh', marginBottom: -2, paddingBottom: 2, backgroundColor: "black", display: 'flex', flexDirection: 'row', borderTopLeftRadius: '28px', borderTopRightRadius: '28px', paddingLeft: 8, paddingRight: 8, paddingTop: 6}}> 
                <IonSegment
                    value={filterType}
                    slot='start'
